 ...
 * @type M1720
 *
 * Properties that can be set on M1720
 */
const SelectClasses = {
	"@dojo/widgets/button": {
		root: [css.button]
 ...
 export interface M1720Properties extends KeyedWidgetProperties{
 }

@theme(css)
export class M1720 extends ThemedMixin(WidgetBase)<M1720Properties> {
	...
	protected render(): DNode | DNode[] {
		return w(Card,{key: 'card-M1720'}, [
			v('h5',{classes: [css.black, css.code]},['M1720']),
			v('p', {classes: [css.label]}, ['When Anxious']),
