 ...
 * @type M1600
 *
 * Properties that can be set on M1600
 */
const SelectClasses = {
	"@dojo/widgets/button": {
		root: [css.button]
 ...
 export interface M1600Properties extends KeyedWidgetProperties{
 }

@theme(css)
export class M1600 extends ThemedMixin(WidgetBase)<M1600Properties> {
	...
	protected render(): DNode | DNode[] {
		return w(Card,{key: 'card-M1600'}, [
			v('h5',{classes: [css.black, css.code]},['M1600']),
			v('p', {classes: [css.label]}, ['Has this patient been treated for a Urinary Tract Infection in the past 14 days?']),
			v('div', {style: 'margin-left:0em'},[
				...
				w(Radio, {
					...
					value: '4',
					label: 'UK - Unknown [Omit "UK" option on DC]',
					name: 'gender',
					onChange: this._radioChange
				}),
