 ...
 * @type M0014
 *
 * Properties that can be set on M0014
 */
 export interface M0014Properties extends KeyedWidgetProperties{
 }

@theme(css)
export class M0014 extends ThemedMixin(WidgetBase)<M0014Properties> {
    private _state: any = {};
	...
	protected render(): DNode | DNode[] {
		return w(Card,{key: 'card-m0014'}, [
            v('h5',{classes: [css.black, css.code]},['M0014']),
            v('p', {classes: [css.label]}, ['Branch State']),
